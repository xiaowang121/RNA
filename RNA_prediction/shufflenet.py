...
class ShuffleNet(nn.Module):
    def __init__(self, cfg):
        ...
        self.conv1 = nn.Conv2d(25, 24, kernel_size=1, bias=False)
        ...
        self.lastlayer = nn.Conv2d(64, 1, 3, padding=1)
        self.sig = nn.Sigmoid()
